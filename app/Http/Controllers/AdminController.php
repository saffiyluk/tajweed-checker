...
class AdminController extends Controller
{
    ...
    // ===== REPORT SCREENSHOT START: Section 4.3.14B - Admin Correction Review =====
    public function updateCorrection(Request $request, AnalysisResult $analysisResult)
    {
        $validated = $request->validate([
            ...
            'expert_target_label' => 'nullable|required_if:correction_review_status,used|in:ikhfa_correct,ikhfa_weak_ghunnah,izhar_correct,izhar_with_ghunnah,other',
        ]);
        ...
        $analysisResult->update([
            ...
            'expert_target_label' => $validated['expert_target_label'] ?? null,
    ...
    // ===== REPORT SCREENSHOT END: Section 4.3.14B - Admin Correction Review =====
